...
class AppColors {
  ...
  static const Color onPrimary = Color(0xFFFFFFFF); // текст на кнопках
  static const Color onBackground = Color(0xFF6B5A6E); // заголовки
  static const Color onSurface = Color(0xFFA89BAE); // обычный текст, placeholder
